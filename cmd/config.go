...
type ExporterConfig struct {
	Type  string `arg:"-f,--format,env:FORMAT" default:"text"`
	SlackConfig
}

type SlackConfig struct {
	ChannelID string `arg:"--slack-channel-id,env:SLACK_CHANNEL_ID"`
	Token     string `arg:"--slack-token,env:SLACK_TOKEN"`
}
